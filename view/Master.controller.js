...
], function(Sorter, utilities) {
	"use strict";
	return sap.ui.core.mvc.Controller.extend("BL_Monitoring.view.Master", {
		...
		onInit: function() {
			...
			this._oReviewTable = this.byId("list");
		...
		checkAll: function(oEvent) {
			this.getView().byId("list").setSelected(true);
		},
		...
		loadDetailView: function() {
			this.getRouter().myNavToWithoutHash({
				...
				targetViewName: "BL_Monitoring.view.Detail",
				targetViewType: "XML"
			});
		},
		...
		onTableSettingsPressed: function() {
			if (!this._oSortDialog) {
				this._oSortDialog = this._createDialog("BL_Monitoring.view.fragment.SettingsDialog");
			}

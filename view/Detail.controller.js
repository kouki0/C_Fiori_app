sap.ui.core.mvc.Controller.extend("BL_Monitoring.view.Detail", {
	...
	/*onLineItemPressed: function(oEvent) {
			...
			router.navTo("WTDetail", null, false);
		},*/
	...
	onRoutePatternMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			currentView: this.getView(),
			targetViewName: "BL_Monitoring.view.WTDetail",
			targetViewType: "XML",
			transition: "slide"
		});
	},
